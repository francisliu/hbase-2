...
import org.apache.hadoop.hbase.master.TestAssignmentManagerOnCluster.MyRegionServer;
...
public class TestMetaHandlerForAssignment {
  ...
  static void setupOnce() throws Exception {
    TEST_UTIL.startMiniCluster(1, 4, null, null, MyRegionServer.class);
  ...
  public void testMultipleServerShutdown() throws Exception {
    ...
    // Stop meta server
    try {
      MyRegionServer.slowDownMetaAssignment = true;
      metaServer.getRegionServer().stop(
        "Stopping meta server" + metaServer.getRegionServer().getServerName());
      ...
      MyRegionServer.slowDownMetaAssignment = false;
    }
